	...
	<form id="frm" action="/login" method="post">
		<fieldset class="fld-login">
			...
			<div class="input-container focus">
				<label class="move active" for="user_id"></label><input type="text" class="no-border active " id="user_id" name="user_id" placeholder="ID" options="{ updateOn: 'keyup blur' }" >
			</div>
			<div class="input-container focus">
