                    ...
                    <div class="comment boardContents">
                        ...
                        <table class="comment-table board-table">
                            <tr class="board-detail-profile">
                                ...
                                <td class="comment-modDel-td"> <!-- 포문 돌릴때 아이디 값 조심 -->
                                    <span id="comment-modDel-td0" class="material-icons cursor" >more_horiz</span>
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                <td colspan="2">동해물과 백두산이 마르고 닳도록 하느님이 보우하사 우리나라 만세 동해물과 백두산이 마르고 닳도록 하느님이 보우하사 우리나라 만세 동해물과 백두산이 마르고 닳도록 하느님이 보우하사 우리나라 만세 동해물과 백두산이 마르고 닳도록 하느님이 보우하사 우리나라 만세
                                </td>
                            </tr>
                            <tr>
                                <td colspan="3">
                    ...
                    <form id="commentIns-form" class="comment-option-box flex-center">
                        <div class="board-btns comment-backTop-btns">
                            ...
                            <div class="go-to-back board-detail-back cursor circle-btn50"
                                onclick="changeLocation('/boardList')">
                        ...
                        <div class="rectangle-small-btn commentIns-btn">
                            등록
                        </div>
                    </form>