...
<div class="board-btns board-detail-btn">
	<!-- 뒤로가기 버튼 -->
	<div class="go-to-back board-detail-back cursor circle-btn50" onclick="backToList()">
...
<div class="board-detail boardContents">
    <table class="board-detail-table board-table">
        <tr class="board-detail-profile">
            ...
            <td class="board-user-name">닉네임</td>
        </tr>
        ...
        <tr class="board-ctnt board-detail-ctnt">
            <td class="board-detail-ctnt" colspan="2">
                <p>동해물과 백두산이 마르고 닳도록 하느님이 보우하사 우리나라 만세
                    ...
                    동해물과 백두산이 마르고 닳도록 하느님이 보우하사 우리나라 만세
                    동해물과 백두산이 마르고 닳도록 하느님이 보우하사 우리나라 만세
                    동해물과 백두산이 마르고 닳도록 하느님이 보우하사 우리나라 만세</p>
                <div class="board-detail-img__box">
                    <img class="board-detail__img" src="/img/test-img.jpg" alt="">
                </div>
                <p>동해물과 백두산이 마르고 닳도록 하느님이 보우하사 우리나라 만세
                    동해물과 백두산이 마르고 닳도록 하느님이 보우하사 우리나라 만세
                    동해물과 백두산이 마르고 닳도록 하느님이 보우하사 우리나라 만세
